...
```
node .Codex/skills/day/lib/build.mjs readback drive/Bryan's Days/today.mrbl
```
...
```
node .Codex/skills/day/lib/build.mjs carry --list
```
...
```
node .Codex/skills/day/lib/build.mjs feedback
```
...
```
node .Codex/skills/day/lib/build.mjs assemble --payload /tmp/nl.json
```
