...
```
cat .claude/skills/my-day/state/profile.json
```
...
```
node .claude/skills/my-day/lib/build.mjs readback drive/Bryan's Days/today.mrbl
```
...
```
node .claude/skills/my-day/lib/build.mjs carry --list
```
...
```
node .claude/skills/my-day/lib/build.mjs feedback
```
...
```
node .claude/skills/my-day/lib/build.mjs assemble --payload /tmp/nl.json
```
